...
const LSM_NODE = 'https://nodes.thetangle.org:443' // latest solid milestone node. sed for getting coordinator tx
const ZMQ_ENDPOINT = 'tcp://zmq.iota.org:5556' // used to get a livestream of all tx
